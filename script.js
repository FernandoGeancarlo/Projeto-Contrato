...
let clinica = [
  {
    ...
    enderecoClinica:
      'AV CASEMIRO JUNIOR, Nº 33 - ANIL, CEP: 65.045-180, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'PC GONÇALVES DIAS, Nº 191 - CENTRO - CEP: 65604-010, CAXIAS - MA'
  },

  {
    ...
    enderecoClinica:
      'R OSWALDO CRUZ, 76, SALA 102 - CENTRO - CEP: 65020-250, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'AV JERONIMO DE ALBUQUERQUE, Nº 5 - COHAB ANIL III - CEP: 65.050-175, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'RUA DA PAZ, Nº 62 - CENTRO - CEP: 65.020-450, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'AV GETULIO VARGAS, Nº 1875 - CENTRO - CEP: 65903-280, IMPERATRIZ - MA'
  },

  {
    ...
    enderecoClinica:
      'AV JOÃO PESSOA, n° 352, LOJA 11 - JOÃO PAULO - CEP: 65040-000, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'AV JOÃO PESSOA, Nº 340 - JORDOA - CEP: 65.041-645, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'AV GETULIO VARGAS, Nº 210 A - JOAO PAULO - CEP: 65.040-020, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'AV.01, N°121 - JARDIM AMÉRICA - CEP: 65058-284, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'R DO NORTE, N°34, SÃO BERNARDO - CEP: 65.055-800	SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'AV GUAJAJARAS, N°480, SALA 107 - JARDIM SÃO CRISTOVÃO - CEP: 65.055-285, SÃO LUIS - MA'
  },

  {
    ...
    enderecoClinica:
      'AV FRANCISCO CARLOS JANSEN, Nº 1050 - PARQUE PIAUÍ - CEP: 65631-240, TIMON - MA'
  },

  {
    ...
    enderecoClinica:
      'TV ANTONIO MACEDO, N°65 - CENTRO - CEP: 65760-000, PRESIDENTE DUTRA - MA'
  },

  {
    ...
    enderecoClinica:
      'RUA DO COMERCIO, N°597 - CENTRO - CEP: 65300-046, SANTA INÊS - MA'
  },

  {
    ...
    enderecoClinica:
      'R PEDRO II, N°970 - CENTRO - CEP: 64.200-420, PARNAIBA - PI'
  },

  {
    ...
    enderecoClinica:
      'AV 4 DE JULHO, N°162, SALA 1 - CENTRO - CEP: 64.260-000, PIRIPIRI - PI'
  },

  {
    ...
    enderecoClinica:
      'R TREZE DE MAIO, N°162, SALA 101 - CENTRO - CEP: 64.000-150, TERESINA - PI'
  },

  {
    ...
    enderecoClinica:
      'RUA ELIZEU MARTINS, N°1224, CENTRO - CEP: 64.000-120, TERESINA - PI'
  },

  {
    ...
    enderecoClinica:
      'Q 36 (CJ DIRCEU ARCOVERDE I), N°13, CASA 13, ITARARE  - CEP: 64.077-104, TERESINA - PI'
  },

  {
    ...
    enderecoClinica:
      'AV JOSE FRANCISCO DE ALMEIDA NETO, SN, QD 172, CASA 10 SALA A, BAIRRO: ITARARE - CEP: 64.077-175, TERESINA - PI'
  },

  {
    ...
    enderecoClinica:
      'RUA ELIZEU MARTINS, N°1257, TERREO 1, CENTRO - CEP: 64.000-120, TERESINA - PI'
  },

  {
    ...
    enderecoClinica:
      'AV. MARECHAL JUAREZ TAVORA, N°11, QD 64, CASA 11 - PARQUE PIAUÍ - CEP: 64.025-520, TERESINA - PI'
  },

  {
    ...
    enderecoClinica:
      'R CEL JUVENCIO CARNEIRO, Nº 276, TERREO - CENTRO - CEP: 58.900-000, CAZAJEIRAS - PB'
  },

  {
    ...
    enderecoClinica:
      'R PRESIDENTE JOAO PESSOA, 21 A, TERREO - CENTRO - CEP: 58.800-010, SOUSA - PB'
  },

  {
    ...
    enderecoClinica:
      'Q QNM 1, CONJUNTO H, N°44, LOJA 01 - CEILÂNDIA SUL - CEP: 72.215-018, BRASILIA - DF'
  },

  {
    ...
    enderecoClinica:
      'Q QN 206, CONJUNTO A LOTE, Nº 02, LOJA 4 - SAMAMBAIA NORTE - CEP: 72.316-501, BRASILIA - DF'
  },

  {
    ...
    enderecoClinica:
      'AV GENERAL ATAIDE TEIVE, Nº 5277 - ASA BRANCA - CEP: 69.312-244, BOA VISTA - RR'
  },

  {
    ...
    enderecoClinica:
      'AV GETULIO VARGAS, Nº 5919 - CENTRO - CEP: 69301-030, BOA VISTA - RR'
  },

  {
    ...
    enderecoClinica:
      'AVENIDA SEBASTIÃO DINIZ, 1002 - CENTRO - CEP: 69.301-040, BOA VISTA - RR'
  },

  {
    ...
    enderecoClinica:
      'AV CONDE DA BOA VISTA, Nº 121, EDF TABIRA LOJA - BOA VISTA - CEP: 50.060-002, RECIFE - PE'
  },

  {
    ...
    enderecoClinica:
      'R NOVA, N°286 - SANTO ANTONIO - CEP: 50.010-100, RECIFE - PE'
  },

  {
    ...
    enderecoClinica:
      'RUA IMPERATRIZ TEREZA CRISTINA, Nº 94 - BOA VISTA - CEP: 50060-120, RECIFE - PE'
  },

  {
    ...
    enderecoClinica:
      'RUA HALFELD, N 397, PAVIMENTO 2 - CENTRO  - CEP: 36010-000, JUIZ DE FORA - MG'
  },

  {
    ...
    enderecoClinica:
      'RUA DOS GUARANIS, Nº 436 - CENTRO - CEP: 30120-040, BELO HORIZONTE - MG'
  },

  {
    ...
    enderecoClinica:
      'PRAÇA MARANHÃO, Nº 599, CAMPINA - CEP: 66019-010, BELÉM - PA'
  },

  {
    ...
    enderecoClinica:
      'RUA CONSELHEIRO JOÃO ALFREDO, Nº 297 - CAMPINA - CEP: 66.013-000, BELÉM - PA'
  },

  {
    ...
    enderecoClinica:
      'R BARAO DE IGARAPE MIRI, Nº 333 - GUAMÁ - CEP: 66.075-000, BELEM - PA'
  },

  {
    ...
    enderecoClinica:
      'AV TREZE DE SETEMBRO, Nº 1913, LETRA C - BURITIZAL - CEP: 68902-865, MACAPÁ - AP'
  },

  {
    ...
    enderecoClinica:
      'PC ONOFRE JOSE SOARES, N°223 - CENTRO - CEP: 59570-000, CEARÁ-MIRIM - RN'
  },

  {
    ...
    enderecoClinica:
      'RUA CINCINATO PINTO, Nº 129 - CENTRO - CEP: 57020-050, MACEIÓ - AL'
  },

  {
    ...
    enderecoClinica:
      'AV. BENEDITO BENTES, QUADRA C12, Nº 1094A - BENEDITO BENTES - CEP: 57084-800, MACEIÓ - AL'
  },

  {
    ...
    enderecoClinica:
      'AV BERNARDO SAYAO, N°1440, QD.03 LOTE 14 SALA 02, INTERLAGOS, CEP:77.600-000, PARAISO DO TOCANTINS- TO'
  },

  {
    ...
    enderecoClinica:
      'AV. BERNARDO SAYÃO, Nº 1090, QD 06, LT 16 - CENTRO - CEP: 77600-000, PARAÍSO DO TOCANTINS - TO'
  },

  {
    ...
    enderecoClinica:
      'AV.TANCREDO NEVES, Nº 451, SL 0451 - CENTRO - CEP: 65975-000, ESTREITO - MA'
  },

  {
    ...
    enderecoClinica:
      'PRAÇA DO CENTENÁRIO, Nº 642 - CENTRO - CEP: 77500-000, PORTO NACIONAL - TO'
  },

  {
    ...
    enderecoClinica:
      'AV. CONÊGO JOÃO LIMA, Nº 2061, QD.: 13, PARTE DO LT. 02A, CENTRO - CEP: 77804-010, ARAGUAÍNA-TO'
  },

  {
    ...
    enderecoClinica:
      'AV. COUTO MAGALHÃES (LOT CENTRO), Nº 2320 - CENTRO NORTE - CEP: 78110-400, VÁRZEA GRANDE/MT'
  },

  {
    ...
    enderecoClinica:
      'AV. SANTANA, Nº 512 - BAIRRO COMERCIAL - CEP: 68925-076, SANTANA - AP'
  },

  {
    ...
    enderecoClinica:
      'RUA PADRE JOÃO MARIA, S/N - CENTRO - CEP: 59550-000, JOÃO CÂMARA - RN'
  },

  {
    ...
    enderecoClinica:
      'RUA DONA OTÍLIA, N°400, LT. 4, QUADRA 1A RS. RIO SOLIMÕES - TARUMÃ - CEP: 69021-005, MANAUS - AM'
  },

  {
    ...
    enderecoClinica:
      'AV. QUEIROS DOS SANTOS, Nº 208 - CENTRO - CEP: 09015-310, SANTO ANDRÉ/SP'
  },

  {
    ...
    enderecoClinica:
      'AV. BEIJA-FLOR, Nº 09, QUADRA 26 - PARQUE UIRAPURU - CEP: 68473-000, NOVO REPARTIMENTO/PA'
  },
